...
void ParticleGenerator::Update(GLfloat dt, MovingSceneObject &object, GLuint newParticles, glm::vec2 offset)
{
	// Add new particles 
...
void ParticleGenerator::respawnParticle(Particle &particle, MovingSceneObject &object, glm::vec2 offset)
{
